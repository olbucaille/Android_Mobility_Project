        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            stop.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Globals.client.send(userDAO.getFBName(AccessToken.getCurrentAccessToken().getUserId()), AccessToken.getCurrentAccessToken().getUserId(),AccessToken.getCurrentAccessToken().getUserId()+test, (int)dist, 0, Client.GIVEACTIVITY);

                    for (HeartBeat hb : hb_stockee ) {
                        Globals.client.send(userDAO.getFBName(AccessToken.getCurrentAccessToken().getUserId()), AccessToken.getCurrentAccessToken().getUserId(),AccessToken.getCurrentAccessToken().getUserId()+test,0, hb.getHeartBeat(), Client.GIVEHB);
                    }
